...
| 05 | [Matter workbench / risk memo](prototypes/05-matter-workbench/SPEC.md) | **validated** | Describe a live layoff → an issue-by-issue risk memo over retrieved precedent: where you're exposed, what respondents will argue, how it's tended to land, what to shore up. 97.8% grounded, matter-specific (3/3 blind-matched), and useful (judge panel 3.67/5). The residual risk is legal characterization, not invented cites — so it's a strong first draft that an attorney reviews, with a self-written "what to verify" section. [sample memo](prototypes/05-matter-workbench/sample_memo.md) · [FINDINGS](prototypes/05-matter-workbench/FINDINGS.md) |
